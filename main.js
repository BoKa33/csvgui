...
async function DataCollectionGui(){ console.log("2: DataCollectionGui");
  ...
  async function recursiveThroughCSV(){ console.log("2.C");
    async function updateImages(){ console.log("2.C.A");
    }
    async function handleButtons(){ console.log("2.C.B");
      async function addEventHandlers(){ console.log("2.C.B.A");
      }
      async function waitForEvent(){ console.log("2.C.B.B:");
      }
      async function removeEventHandler(){ console.log("2.C.B.C");
      }
    }
  }
